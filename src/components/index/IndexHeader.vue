...
<script>
	export default {
		...
		mounted() {
            ...
            this.imgUrl = this.user.touxiang;
          }
					else if(this.user.zhaopian){
					  this.imgUrl = this.user.zhaopian;
          }
					else{
					  this.imgUrl = 'https://img0.baidu.com/it/u=4138837499,2587601231&fm=253&fmt=auto&app=138&f=JPEG?w=505&h=458';
          }
				} else {
...
<style lang="scss" scoped>
    ...
    background-color: #8dafac;
      ...
      .avatar:hover {
        transform: scale(1.1); /* 图片悬停时放大 10% */
        box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); /* 图片悬停时添加阴影效果 */
      }
