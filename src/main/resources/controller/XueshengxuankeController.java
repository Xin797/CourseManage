...
public class XueshengxuankeController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XueshengxuankeEntity xueshengxuanke, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XueshengxuankeEntity xueshengxuanke, HttpServletRequest request){
        EntityWrapper<XueshengxuankeEntity> ew = new EntityWrapper<XueshengxuankeEntity>();
		PageUtils page = xueshengxuankeService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xueshengxuanke), params), params));
        return R.ok().put("data", page);
    }
